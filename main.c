...
int main(void) {
	...
	unsigned char spaceOne = 0x00; // Hold's value of 1st parking space
	unsigned char spaceTwo = 0x00; // Hold's value of 2nd parking space
	unsigned char spaceThree = 0x00; // Hold's value of 3rd parking space
	unsigned char spaceFour = 0x00; // Hold's value of 4th parking space
